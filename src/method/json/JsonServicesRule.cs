...
namespace PitneyBowes.Developer.ShippingApi.Json
{
    ...
    public class JsonServicesRule<T> : JsonWrapper<T>, ISpecialServicesRule where T : ISpecialServicesRule, new()
    {
        public JsonServicesRule() : base() { }
        public JsonServicesRule(T t) : base(t) { }
